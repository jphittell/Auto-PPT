...
Read `AGENTS.md`, [conftest.py](C:/Users/jphit/OneDrive/Desktop/Codex/Projects/Auto%20PPT/tests/conftest.py), and the relevant service module before editing tests.
...
- Add new test files by service area when the implementation expands beyond the current Phase 1 coverage.
